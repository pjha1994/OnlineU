...
.primary-1 { background-color: #82A082 }
.primary-2 { background-color: #5E7E5E }
.primary-0 { background-color: #415C41 }
.primary-3 { background-color: #243F24 }
.primary-4 { background-color: #153915 }
...
<p>Palette URL: <a href="http://paletton.com/#uid=12P0u0k9uer5Wp686jMdT9Vkh90">http://paletton.com/#uid=12P0u0k9uer5Wp686jMdT9Vkh90</a></p>

<table class="color-table">
	<tr>
		<th>Primary color:</th>
		<td class="sample sample-1 primary-1">
			<div class="white">#82A082</div>
			<div class="black">#82A082</div>
		</td>
		<td class="sample sample-2 primary-2">
			<div class="white">#5E7E5E</div>
			<div class="black">#5E7E5E</div>
		</td>
		<td class="sample sample-0 primary-0">
			<div class="white">#415C41</div>
			<div class="black">#415C41</div>
		</td>
		<td class="sample sample-3 primary-3">
			<div class="white">#243F24</div>
			<div class="black">#243F24</div>
		</td>
		<td class="sample sample-4 primary-4">
			<div class="white">#153915</div>
			<div class="black">#153915</div>
		</td>
	</tr>
</table>
